      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 mb-12">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-gray-800 ml-4">
        ...
        {/* Qualifications */}
        <div className="bg-gray-50 rounded-lg p-6 sm:p-8 mb-12">
          <div className="flex items-center mb-6">
            <div className="bg-primary/10 rounded-full p-3 sm:p-4">
        ...
        <div className="bg-gray-50 rounded-lg p-6 sm:p-8 mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {affiliations.map((affiliation, index) => (
              <div key={index} className="flex items-start space-x-3">
                <Users className="h-4 w-4 sm:h-5 sm:w-5 text-primary mt-1 flex-shrink-0" />
                <span className="text-gray-700 text-sm sm:text-base">
                  {affiliation}
                </span>
              </div>
